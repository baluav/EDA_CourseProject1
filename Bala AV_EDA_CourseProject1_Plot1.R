...
png(filename='d:/plot1.png')

# Using the hist function statement to plot the graph for the requested data
hist(HHP_full_Data$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
